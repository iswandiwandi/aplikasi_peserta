                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')" href="tambah-level.php?delete=<?php echo $datalevel['id'] ?>" class="btn btn-danger btn-sm">Hapus</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
