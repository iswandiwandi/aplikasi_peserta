...
if (isset ($_POST ['simpan'])) {
    ...
    $insertUser = mysqli_query($koneksi, "INSERT INTO user (nama, email, password) VALUES('$nama','$email', '$password')");
...
if (isset($_POST['edit'])) {
    ...
    $edit = mysqli_query($koneksi, "UPDATE user SET nama='$nama', email='$email', password = '$password' WHERE id = '$id'");
}
