...
if (isset ($_POST ['simpan'])) {
    ...
    // masukkan ke dalam table level dimana kolom nama di ambil nilainya dari inputan nama

    $insertlevel = mysqli_query($koneksi, "INSERT INTO level (nama_level) VALUES('$nama')");
...
// tampilkan semua data dari tabel level dimana id nya di ambil dari params edit
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
...
if (isset($_POST['edit'])) {
    ...
    // ubah data dari table level dimana nilai nama di ambil dari inputan nama
    // dan nilai id level nya di ambil dari parameter
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="mb-3">
                                        ...
                                        <input value="<?php  echo $dataEdit['nama_level']?>" type="text" class="form-control" name="nama" placeholder="Masukkan Nama Lengkap Anda..">
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    <div class="mb-3">
                                        <label for="">Nama Level</label>
                                        <input value="" type="text" class="form-control" name="nama" placeholder="Masukkan Nama Lengkap Anda..">
                                    </div>
