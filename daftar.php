                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post">
                                        ...
                                        <div class="form-group">
                                            <input name="pendidikan" type="text" class="form-control form-control-user" id="exampleInputPendidikan" aria-describedby="emailHelp" placeholder="Masukkan Pendidikan Terakhir Anda">
                                        </div>
