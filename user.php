...
$queryUser = mysqli_query($koneksi, "SELECT user.id, user.nama, user.email, level.nama_level FROM user LEFT JOIN level ON level.id = user.id_level ORDER BY user.id DESC");
